...
const DeviceSupports = () => {
  return (
    <div className="card_container flex flex-wrap items-center justify-center gap-5">
      <div className="card group flex aspect-square h-36 flex-col items-center justify-center gap-2 rounded-lg bg-gray-100 lg:h-48">
        <Image
          src={Chrome}
          alt="chrome"
